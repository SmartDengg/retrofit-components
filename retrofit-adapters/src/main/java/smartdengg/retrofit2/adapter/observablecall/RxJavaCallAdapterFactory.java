...
public final class RxJavaCallAdapterFactory extends CallAdapter.Factory {
  ...
  public CallAdapter<?, ?> get(Type returnType, Annotation[] annotations, Retrofit retrofit) {
    ...
    final boolean isObservable = "rx.Observable".equals(rawType.getCanonicalName());
    final boolean isSingle = "rx.Single".equals(rawType.getCanonicalName());
    final boolean isCompletable = "rx.Completable".equals(rawType.getCanonicalName());
